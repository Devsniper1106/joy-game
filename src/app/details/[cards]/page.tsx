    ...
    <div className="px-8">
      <div className="flex flex-col justify-between  gap-8 lg:flex-row">
        <div className="w-full  py-8 px-10">
          <div className="flex h-[300px] max-w-[800px] gap-5 py-[45px] px-[66px] bg-[#0206177A] rounded-[36px]">
            <Card
            ...
            <div className='p-6'>
              ...
              <button className="flex align-middle px-12 py-3 rounded-[36px] outline-4 outline-[#A3E635] bg-[#6366F14D]">
                <Image
                  alt="button"
